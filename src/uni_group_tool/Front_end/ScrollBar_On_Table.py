...
class AddScrollbar(customtkinter.CTkFrame):
    def __init__(self, *args,data, **kwargs):
        ...
        my_cavas = Canvas(self, width=160, height=200, background=self["bg"], bd=0, highlightthickness=0)
        ...
        my_cavas.bind('<Configure>',lambda e: my_cavas.configure(scrollregion=my_cavas.bbox("all")))
